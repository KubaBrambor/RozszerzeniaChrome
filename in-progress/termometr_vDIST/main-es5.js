                ...
                CardComponent.prototype.ngOnInit = function () {
                    ...
                    this.http.get(this.url).subscribe(function (data) {
                        for (var i = 0; i < data.result.records.length; i++) {
                            _this.localArr.push(data.result.records[i]);
                        }
